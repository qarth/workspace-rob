...
cprequire_test(["inline:com-chilipeppr-workspace-rob"], function(ws) {
    ...
    $('title').html("rob Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-rob", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-rob", // Make the id the same as the cpdefine id
        name: "Workspace / rob", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace rob.`,
        ...
        /**
         * Load the Template widget via chilipeppr.load() so folks have a rob
